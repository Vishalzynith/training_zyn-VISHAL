pageextension 50156 Zyn_SalesCreditExt extends "Sales Credit Memo"
{
    layout
    {
        addlast(content)
                ...
                field("Beginn Text Code"; Rec."Beginning Text")
                {
                    ...
                    begin
                        ...
                        if Customer.Get(Rec."Sell-to Customer No.") then begin
                            ExtendedTextLine.SetRange("No.", Rec."Beginning Text");
            ...
            group("Endd Text")
            {
                field("Endd Text Code"; Rec."Ending Text")
                {
                    ...
                    begin
                        ...
                        if Customer.Get(Rec."Sell-to Customer No.") then begin
                            ExtendedTextLine.SetRange("No.", Rec."Ending Text");
                            ExtendedTextLine.SetRange("Language Code", Customer."Language Code");
